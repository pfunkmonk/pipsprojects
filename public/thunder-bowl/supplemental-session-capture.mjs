...
export const SUPPLEMENTAL_REQUIRED_HELPER_VERSION = "0.10.10";
export const SUPPLEMENTAL_COMPATIBLE_HELPER_VERSIONS = Object.freeze([SUPPLEMENTAL_REQUIRED_HELPER_VERSION]);
