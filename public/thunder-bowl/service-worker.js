const CACHE_VERSION = "thunder-bowl-shell-v57";
const APP_SHELL = [
  "/thunder-bowl/",
  ...
  "/thunder-bowl/app.css?v=20260808f",
  "/thunder-bowl/app.mjs?v=20260808f",
  "/thunder-bowl/public-board.mjs?v=20260805g",
  "/thunder-bowl/state-engine.mjs?v=20260808f",
  ...
  "/thunder-bowl/keeper-board.mjs?v=20260808f",
  "/thunder-bowl/keeper-scenario.mjs?v=20260808f",
  "/thunder-bowl/draft-history.mjs?v=20260808f",
