...
- The release-candidate gate passes 268/268 automated tests, the 716-player build validator, the full-auction rehearsal (168 sales), and the catastrophe rehearsal (24 keepers plus 144 sales). The active weekly-asset pack is `tb26-tb-accuracy-consensus-20260809-v1-20260809224311-weekly-assets-20260810033019`. The released market model improves matched historical auction-price MAE from 5.887 to 4.191 (28.8%) with 79.4% held-out 80% interval coverage.
