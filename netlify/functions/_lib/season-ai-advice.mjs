...
- Current-season salary and contract cost never increase start/sit, ordinary free-agent, or current-season trade value. In ordinary waivers, a captured inexpensive keeper contract may act only as a protective veto against dropping an existing asset; never presume an unknown winning bid creates a cheap keeper. The explicit stash-watch section is the positive-value exception in every week: there, a low acquisition salary can create next-season keeper value or salary-cap trade leverage.
